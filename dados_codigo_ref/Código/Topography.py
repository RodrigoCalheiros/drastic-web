...
class Topography(QDialog, Ui_Topography):
    ...
    def convert(self):
        ...
        if self.inputLayerCombo.currentText()!="":
            ...
            outGrid = userDir + "." + "tif"
            Processing.runAlgorithm("grass7:r.slope.aspect",None, outGrid, 1, 1, 1.0, 0.0, extent, cellSize, userSlope, None, None, None, None, None, None, None, None)
