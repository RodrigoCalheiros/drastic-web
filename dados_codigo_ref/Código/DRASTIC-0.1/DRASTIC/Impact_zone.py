...
from Ui_Impact_zone import Ui_Impact_zone
...
class Impact_zone(QDialog, Ui_Impact_zone):
    ...
    def help(self):
        QMessageBox.about(self, "Impact of vadose zone", """<p><b>Impact of Vadose Zone factor</b></p> 
        <p><b>Definition:</b>The I factor concerns the way how the type of geologic material occurring below the soil layer and above the saturated zone controls the pollutant attenuation. 
        The creation of this feature is also similar to the Aquifer Media factor. </p>
        <p><b>Method</b></p> 
        ...
        <p><b>Output file:</b> Impact of Vadose Zone raster file</p>""")    
    ...
    def convert(self):    
        ...
        impact_zone = QFileInfo(QgsApplication.qgisUserDbFilePath()).path() + "/impact_zone"
        Processing.runAlgorithm("grass7:v.to.rast.attribute", None, inputLayer, 0, parameter_indexes, extent, cellSize, -1.0, 0.0001, impact_zone)
        impact_complete = impact_zone + "." + "tif"        
        
        
        Processing.runAlgorithm("grass:r.surf.idw", None, impact_complete, 12, False, extent, cellSize, outPath)  
