...
class Ui_Superficie_topografica(object):

    def setupUi(self, Superficie_topografica_window):
        # create Superficie_topografica window
        Superficie_topografica_window.setWindowModality(QtCore.Qt.ApplicationModal)
        Superficie_topografica_window.resize(450, 400)

        # input file contour
        # create gridLayout
        self.gridLayout1 = QGridLayout(Superficie_topografica_window)
        self.gridLayout1.setObjectName("gridLayout1")
        # create label in gridLayout 
        self.label = QLabel(Superficie_topografica_window)
        self.label.setObjectName("label")
        # define label (QWidget, row, column, QtAlignement)
        self.gridLayout1.addWidget(self.label, 0, 0, 1, 1)
        # create select button to input file
        self.selectButton = QPushButton(Superficie_topografica_window)
        self.selectButton.setObjectName("selectButton")
        self.gridLayout1.addWidget(self.selectButton, 0, 2, 1, 1)
        self.inputLayerCombo = QComboBox(Superficie_topografica_window)
        ...
        self.groupBox1 = QGroupBox(Superficie_topografica_window)
        ...
        # define the indexs
        # create a group box
        self.groupBox = QGroupBox(Superficie_topografica_window)
        ...
        self.tableWidget = QTableWidget(5, 3, Superficie_topografica_window)
        ...
        # button Add
        self.buttonAdd = QPushButton(Superficie_topografica_window)
        self.buttonAdd.setObjectName("buttonAdd")
        self.boxLayout.addWidget(self.buttonAdd)
        # button Remove
        self.buttonRemove = QPushButton(Superficie_topografica_window)
        self.buttonRemove.setObjectName("buttonRemove")
        self.boxLayout.addWidget(self.buttonRemove)
        self.gridLayout2.addLayout(self.boxLayout, 0, 1, -1, 1)
        ## button weight
        # self.labelWeight = .QLabel(Superficie_topografica_window)
        ...
        # output file
        # create label in gridLayout
        self.label3 = QLabel(Superficie_topografica_window)
        self.label3.setObjectName("label3")
        # define label (QWidget, row, column, QtAlignement)
        self.gridLayout1.addWidget(self.label3, 4, 0, 1, 1)
        # create select button to input file
        self.selectButton3 = QPushButton(Superficie_topografica_window)
        self.selectButton3.setObjectName("selectButton3")
        self.gridLayout1.addWidget(self.selectButton3, 4, 2, 1, 1)
        self.inputLayerCombo3 = QLineEdit(Superficie_topografica_window)
        ...
        self.buttonBox = QDialogButtonBox(Superficie_topografica_window)
        ...
        self.retranslateUi(Superficie_topografica_window)
        self.buttonBox.rejected.connect(Superficie_topografica_window.close)

    def retranslateUi(self, Superficie_topografica_window):
        Superficie_topografica_window.setWindowTitle('Superficie_topografica (T)')
        ...
        self.tableWidget.horizontalHeaderItem(0).setText("Superficie_topografica(%)")
        self.tableWidget.horizontalHeaderItem(1).setText("Superficie_topografica(%)")
        ...
        # self.labelWeight.setText(.QApplication.translate('Superficie_topografica (T)', 'Weight:', None, .QApplication.UnicodeUTF8))
