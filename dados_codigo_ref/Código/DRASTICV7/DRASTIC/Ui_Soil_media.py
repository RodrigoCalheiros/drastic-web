...
class Ui_Soil_media(object):
    ...
    def setupUi(self, Soil_window):
        ...
        self.groupBox1 = QGroupBox(Soil_window)
        ...
        # define the indexs
        # create a group box
        self.groupBox = QGroupBox(Soil_window)
        ...
        self.tableWidget = QTableWidget(11,2,Soil_window)
        ...
        self.line = QLineEdit("Shrinking and/or Aggregated Clay")
        ...
        self.line = QLineEdit("Silty Loam")
        ...
        self.line = QLineEdit("Nonshrinking and Nonaggregated Clay")
        ...
        # button Add
        self.buttonAdd = QPushButton(Soil_window)
        self.buttonAdd.setObjectName("buttonAdd")
        self.boxLayout.addWidget(self.buttonAdd)
        # button Remove
        self.buttonRemove = QPushButton(Soil_window)
        self.buttonRemove.setObjectName("buttonRemove") 
        self.boxLayout.addWidget(self.buttonRemove)
        # attribute table button
        self.buttonAttribute = QPushButton(Soil_window)
        ...
        ## button weight
        #self.labelWeight = .QLabel(Soil_window)
        ...
        self.buttonBox = QDialogButtonBox(Soil_window)
        ...
        self.buttonBox.rejected.connect(Soil_window.close)
                
    def retranslateUi(self, Soil_window):
        Soil_window.setWindowTitle('Soil Media (S)')
        self.label.setText( 'Input file:')
        self.selectButton.setText('Browse')
        self.groupBox.setTitle( "Ratings")
        self.tableWidget.horizontalHeaderItem(0).setText("Soil Media")
        ...
        #self.labelWeight.setText(.QApplication.translate('Soil Media (S)', 'Weight:', None, .QApplication.UnicodeUTF8))