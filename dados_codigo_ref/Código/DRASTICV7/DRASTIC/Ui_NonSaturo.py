...
class Ui_NoSaturo(object):
    ...
    def setupUi(self, NoSaturo):
        # create Depth window
        NoSaturo.setWindowModality(QtCore.Qt.ApplicationModal)
        NoSaturo.resize(400, 400)

        # input file points
        # create gridLayout
        self.gridLayout1 = QGridLayout(NoSaturo)
        self.gridLayout1.setObjectName("gridLayout1")
        # create groupBox method I
        self.groupBox_m1 = QGroupBox(NoSaturo)
        ...
        self.selectButton = QPushButton(NoSaturo)
        self.selectButton.setObjectName("selectButton")
        self.gridLayout_m1.addWidget(self.selectButton, 0, 2, 1, 1)
        self.inputLayerCombo = QComboBox(NoSaturo)
        ...
        self.maskLabel = QLabel(NoSaturo)
        ...
        self.methodLabel = QLabel(NoSaturo)
        ...
        self.comboBoxMethod = QComboBox(NoSaturo)
        ...
        self.groupBox1 = QGroupBox(NoSaturo)
        ...
        self.groupBox_m2 = QGroupBox(NoSaturo)
        ...
        self.groupBox_max = QGroupBox(NoSaturo)
        ...
        self.label_max_depth = QLabel(NoSaturo)
        ...
        # field to distance
        self.label_distance = QLabel(NoSaturo)
        ...
        self.label_size = QLabel(NoSaturo)
        ...
        # define the indexs
        # create a group box
        self.groupBox = QGroupBox(NoSaturo)
        ...
        self.tableWidget = QTableWidget(7, 3, NoSaturo)
        ...
        # button Add
        self.buttonAdd = QPushButton(NoSaturo)
        self.buttonAdd.setObjectName("buttonAdd")
        self.boxLayout.addWidget(self.buttonAdd)
        # button Remove
        self.buttonRemove = QPushButton(NoSaturo)
        self.buttonRemove.setObjectName("buttonRemove")
        self.boxLayout.addWidget(self.buttonRemove)
        ## button weight
        # self.labelWeight = QtGui.QLabel(NoSaturo)
        ...
        self.buttonBox = QDialogButtonBox(NoSaturo)
        ...
        self.retranslateUi(NoSaturo)
        self.buttonBox.rejected.connect(NoSaturo.close)

    def retranslateUi(self, NoSaturo):
        NoSaturo.setWindowTitle('Depth Groundwater (D)')
