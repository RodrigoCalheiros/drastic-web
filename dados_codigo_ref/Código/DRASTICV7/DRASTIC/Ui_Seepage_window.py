...
class Ui_Seepage_window(object):

    def setupUi(self, Seepage_window):
        # create Seepage window
        Seepage_window.setWindowModality(QtCore.Qt.ApplicationModal)
        Seepage_window.resize(450, 400)

        # input file
        # create gridLayout
        self.gridLayout1 = QGridLayout(Seepage_window)
        self.gridLayout1.setObjectName("gridLayout1")
        # group box to input files
        self.groupBox = QGroupBox(Seepage_window)
        ...
        self.label = QLabel(Seepage_window)
        self.label.setObjectName("label")
        self.label2 = QLabel(Seepage_window)
        self.label2.setObjectName("label2")
        self.label3 = QLabel(Seepage_window)
        self.label3.setObjectName("label3")
        self.label4 = QLabel(Seepage_window)
        self.label4.setObjectName("label4")
        self.label5 = QLabel(Seepage_window)
        self.label5.setObjectName("label5")
        self.label6 = QLabel(Seepage_window)
        self.label6.setObjectName("label6")
        self.label7 = QLabel(Seepage_window)
        ...
        self.selectButton = QPushButton(Seepage_window)
        self.selectButton.setObjectName("selectButton")
        self.selectButton2 = QPushButton(Seepage_window)
        self.selectButton2.setObjectName("selectButton2")
        self.selectButton3 = QPushButton(Seepage_window)
        self.selectButton3.setObjectName("selectButton3")
        self.selectButton4 = QPushButton(Seepage_window)
        self.selectButton4.setObjectName("selectButton4")
        self.selectButton5 = QPushButton(Seepage_window)
        self.selectButton5.setObjectName("selectButton5")
        self.selectButton6 = QPushButton(Seepage_window)
        self.selectButton6.setObjectName("selectButton6")
        self.selectButton7 = QPushButton(Seepage_window)
        self.selectButton7.setObjectName("selectButton7")

        # button weight Depth to Groundwater
        self.labelWeightD = QLabel(Seepage_window)
        ...
        self.labelWeightR = QLabel(Seepage_window)
        ...
        self.labelWeightA = QLabel(Seepage_window)
        ...
        # button weight Soil
        self.labelWeightS = QLabel(Seepage_window)
        ...
        self.labelWeightT = QLabel(Seepage_window)
        ...
        self.labelWeightI = QLabel(Seepage_window)
        ...
        self.labelWeightC = QLabel(Seepage_window)
        ...
        self.inputLayerCombo = QComboBox(Seepage_window)
        self.inputLayerCombo.setObjectName("inputLayerCombo")
        self.inputLayerCombo2 = QComboBox(Seepage_window)
        self.inputLayerCombo2.setObjectName("inputLayerCombo2")
        self.inputLayerCombo3 = QComboBox(Seepage_window)
        self.inputLayerCombo3.setObjectName("inputLayerCombo3")
        self.inputLayerCombo4 = QComboBox(Seepage_window)
        self.inputLayerCombo4.setObjectName("inputLayerCombo4")
        self.inputLayerCombo5 = QComboBox(Seepage_window)
        self.inputLayerCombo5.setObjectName("inputLayerCombo5")
        self.inputLayerCombo6 = QComboBox(Seepage_window)
        self.inputLayerCombo6.setObjectName("inputLayerCombo6")
        self.inputLayerCombo7 = QComboBox(Seepage_window)
        ...
        self.label_checkSeepage = QLabel(Seepage_window)
        self.label_checkSeepage.setObjectName("label_checkSeepage")
        self.gridLayout3.addWidget(self.label_checkSeepage, 1, 1, 1, 1)
        self.checkSeepage = QCheckBox(Seepage_window)
        self.checkSeepage.setObjectName("checkSeepage")
        self.gridLayout3.addWidget(self.checkSeepage, 1, 0, 1, 1)


        # button Ok, Close and Help
        self.buttonBox = QDialogButtonBox(Seepage_window)
        ...
        self.retranslateUi(Seepage_window)
        self.buttonBox.rejected.connect(Seepage_window.close)

    def retranslateUi(self, Seepage_window):
        Seepage_window.setWindowTitle('Seepage')
        ...
        self.label_out.setText('Seepage:')
        self.groupBox.setTitle("Input")
        self.groupBox2.setTitle("Output")
        self.label_checkSeepage.setText('Load raster into canvas')
