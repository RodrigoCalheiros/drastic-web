...
class Ui_Acquifero(object):

    def setupUi(self, Acquifero_window):
        # create Aquifer window
        Acquifero_window.setWindowModality(QtCore.Qt.ApplicationModal)
        Acquifero_window.resize(450, 800)

        # input file
        # create gridLayout
        self.gridLayout1 = QGridLayout(Acquifero_window)
        self.gridLayout1.setObjectName("gridLayout1")
        # create label in gridLayout 
        self.label = QLabel(Acquifero_window)
        self.label.setObjectName("label")
        # define label (QWidget, row, column, QtAlignement)
        self.gridLayout1.addWidget(self.label, 0, 0, 1, 1)
        # create select button to input file
        self.selectButton = QPushButton(Acquifero_window)
        self.selectButton.setObjectName("selectButton")
        self.gridLayout1.addWidget(self.selectButton, 0, 2, 1, 1)
        self.inputLayerCombo = QComboBox(Acquifero_window)
        ...
        self.groupBox1 = QGroupBox(Acquifero_window)
        ...
        # define the indexs
        # create a group box
        self.groupBox = QGroupBox(Acquifero_window)
        ...
        self.tableWidget = QTableWidget(10, 2, Acquifero_window)
        ...
        self.line = QLineEdit("Medium-fine alluvial dep.")
        ...
        self.line = QLineEdit("Sandstone, conglomerate")
        self.tableWidget.setItem(6, 0, QTableWidgetItem(self.line.text()))
        self.line = QLineEdit("Fissure plutonic rock")
        ...
        self.line = QLineEdit("Fissured vocanic rock")
        ...
        self.line = QLineEdit("Fissured methamorphic rock")
        self.tableWidget.setItem(14, 0, QTableWidgetItem(self.line.text()))
        # set the indexes values
        self.line = QLineEdit("8-9")
        self.tableWidget.setItem(0, 1, QTableWidgetItem(self.line.text()))
        self.line = QLineEdit("9-10")
        ...
        # button Add
        self.buttonAdd = QPushButton(Acquifero_window)
        self.buttonAdd.setObjectName("buttonAdd")
        self.boxLayout.addWidget(self.buttonAdd)
        # button Remove
        self.buttonRemove = QPushButton(Acquifero_window)
        self.buttonRemove.setObjectName("buttonRemove")
        self.boxLayout.addWidget(self.buttonRemove)
        # attribute table button
        self.buttonAttribute = QPushButton(Acquifero_window)
        ...
        ## button weight
        # self.labelWeight = .QLabel(Acquifero_window)
        ...
        self.buttonBox = QDialogButtonBox(Acquifero_window)
        ...
        self.retranslateUi(Acquifero_window)
        self.buttonBox.rejected.connect(Acquifero_window.close)

    def retranslateUi(self, Acquifero_window):
        Acquifero_window.setWindowTitle('Acquifero (A)')
        self.label.setText('Input file:')
        self.selectButton.setText('Browse')
        self.groupBox.setTitle("Ratings")
        self.tableWidget.horizontalHeaderItem(0).setText("Acquifero")
