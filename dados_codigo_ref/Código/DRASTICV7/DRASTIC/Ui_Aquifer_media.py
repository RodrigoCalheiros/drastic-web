...
class Ui_Aquifer_media(object):
    ...
    def setupUi(self, Aquifer_window):
        ...
        self.line = QLineEdit("Bedded Sandstone, Limestone and Shale Sequences")
    ...
    def retranslateUi(self, Aquifer_window):
        ...
        #self.labelWeight.setText(.QApplication.translate('Aquifer Media (A)', 'Weight:', None, .QApplication.UnicodeUTF8))