...
from .Ui_AquiferLithology import Ui_AquiferLithology
...
class AquiferLithology(QDialog, Ui_AquiferLithology):
    ...
    def convert(self):    
        ...
        #aquifer = QFileInfo(QgsApplication.qgisUserDatabaseFilePath()).path() + "/aquifer"
