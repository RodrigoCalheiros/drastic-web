...
class Ui_Depth(object):
    ...
    def setupUi(self, Depth_window):
        ...
        self.tableWidget = QTableWidget(4,3,Depth_window)
        ...
        ## button weight
        #self.labelWeight = .QLabel(Depth_window)
    ...
    def retranslateUi(self, Depth_window):
        ...
        #self.labelWeight.setText(.QApplication.translate('Depth Groundwater (D)', 'Weight:', None, .QApplication.UnicodeUTF8))
