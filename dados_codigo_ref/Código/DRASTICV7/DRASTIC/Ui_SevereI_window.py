...
class Ui_SevereI_window(object):

    def setupUi(self, SevereI_window):
        # create SevereI window
        SevereI_window.setWindowModality(QtCore.Qt.ApplicationModal)
        SevereI_window.resize(450, 400)

        # input file
        # create gridLayout
        self.gridLayout1 = QGridLayout(SevereI_window)
        self.gridLayout1.setObjectName("gridLayout1")
        # group box to input files
        self.groupBox = QGroupBox(SevereI_window)
        ...
        self.label = QLabel(SevereI_window)
        self.label.setObjectName("label")
        self.label2 = QLabel(SevereI_window)
        self.label2.setObjectName("label2")
        self.label3 = QLabel(SevereI_window)
        self.label3.setObjectName("label3")
        self.label4 = QLabel(SevereI_window)
        self.label4.setObjectName("label4")
        self.label5 = QLabel(SevereI_window)
        self.label5.setObjectName("label5")
        self.label6 = QLabel(SevereI_window)
        self.label6.setObjectName("label6")
        self.label7 = QLabel(SevereI_window)
        ...
        self.selectButton = QPushButton(SevereI_window)
        self.selectButton.setObjectName("selectButton")
        self.selectButton2 = QPushButton(SevereI_window)
        self.selectButton2.setObjectName("selectButton2")
        self.selectButton3 = QPushButton(SevereI_window)
        self.selectButton3.setObjectName("selectButton3")
        self.selectButton4 = QPushButton(SevereI_window)
        self.selectButton4.setObjectName("selectButton4")
        self.selectButton5 = QPushButton(SevereI_window)
        self.selectButton5.setObjectName("selectButton5")
        self.selectButton6 = QPushButton(SevereI_window)
        self.selectButton6.setObjectName("selectButton6")
        self.selectButton7 = QPushButton(SevereI_window)
        self.selectButton7.setObjectName("selectButton7")

        # button weight Depth to Groundwater
        self.labelWeightD = QLabel(SevereI_window)
        ...
        self.labelWeightR = QLabel(SevereI_window)
        ...
        self.labelWeightA = QLabel(SevereI_window)
        ...
        # button weight Soil
        self.labelWeightS = QLabel(SevereI_window)
        ...
        self.labelWeightT = QLabel(SevereI_window)
        ...
        self.labelWeightI = QLabel(SevereI_window)
        ...
        self.labelWeightC = QLabel(SevereI_window)
        ...
        self.inputLayerCombo = QComboBox(SevereI_window)
        self.inputLayerCombo.setObjectName("inputLayerCombo")
        self.inputLayerCombo2 = QComboBox(SevereI_window)
        self.inputLayerCombo2.setObjectName("inputLayerCombo2")
        self.inputLayerCombo3 = QComboBox(SevereI_window)
        self.inputLayerCombo3.setObjectName("inputLayerCombo3")
        self.inputLayerCombo4 = QComboBox(SevereI_window)
        self.inputLayerCombo4.setObjectName("inputLayerCombo4")
        self.inputLayerCombo5 = QComboBox(SevereI_window)
        self.inputLayerCombo5.setObjectName("inputLayerCombo5")
        self.inputLayerCombo6 = QComboBox(SevereI_window)
        self.inputLayerCombo6.setObjectName("inputLayerCombo6")
        self.inputLayerCombo7 = QComboBox(SevereI_window)
        ...
        self.label_checkSevereI = QLabel(SevereI_window)
        self.label_checkSevereI.setObjectName("label_checkSevereI")
        self.gridLayout3.addWidget(self.label_checkSevereI, 1, 1, 1, 1)
        self.checkSevereI = QCheckBox(SevereI_window)
        self.checkSevereI.setObjectName("checkSevereI")
        self.gridLayout3.addWidget(self.checkSevereI, 1, 0, 1, 1)


        # button Ok, Close and Help
        self.buttonBox = QDialogButtonBox(SevereI_window)
        ...
        self.retranslateUi(SevereI_window)
        self.buttonBox.rejected.connect(SevereI_window.close)

    def retranslateUi(self, SevereI_window):
        SevereI_window.setWindowTitle('Severe Impact')
        ...
        self.label_out.setText('SevereI:')
        self.groupBox.setTitle("Input")
        self.groupBox2.setTitle("Output")
        self.label_checkSevereI.setText('Load raster into canvas')
