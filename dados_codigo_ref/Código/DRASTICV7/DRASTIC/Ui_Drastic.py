...
class Ui_Drastic(object):
    ...
    def setupUi(self, Drastic_window):
        ...
        # input file
        # create gridLayout
        self.gridLayout1 = QGridLayout(Drastic_window)
        self.gridLayout1.setObjectName("gridLayout1")
        # group box to input files
        self.groupBox = QGroupBox(Drastic_window)
        ...
        self.label = QLabel(Drastic_window)
        self.label.setObjectName("label")  
        self.label2 = QLabel(Drastic_window)
        self.label2.setObjectName("label2")  
        self.label3 = QLabel(Drastic_window)
        self.label3.setObjectName("label3")  
        self.label4 = QLabel(Drastic_window)
        self.label4.setObjectName("label4")  
        self.label5 = QLabel(Drastic_window)
        self.label5.setObjectName("label5")   
        self.label6 = QLabel(Drastic_window)
        self.label6.setObjectName("label6")   
        self.label7 = QLabel(Drastic_window)
        ...
        self.selectButton = QPushButton(Drastic_window)
        self.selectButton.setObjectName("selectButton")
        self.selectButton2 = QPushButton(Drastic_window)
        self.selectButton2.setObjectName("selectButton2")    
        self.selectButton3 = QPushButton(Drastic_window)
        self.selectButton3.setObjectName("selectButton3")  
        self.selectButton4 = QPushButton(Drastic_window)
        self.selectButton4.setObjectName("selectButton4")  
        self.selectButton5 = QPushButton(Drastic_window)
        self.selectButton5.setObjectName("selectButton5")  
        self.selectButton6 = QPushButton(Drastic_window)
        self.selectButton6.setObjectName("selectButton6")  
        self.selectButton7 = QPushButton(Drastic_window)
        self.selectButton7.setObjectName("selectButton7")    
        
        # button weight Depth to Groundwater
        self.labelWeightD = QLabel(Drastic_window)
        ...
        self.labelWeightR = QLabel(Drastic_window)
        ...
        self.labelWeightA = QLabel(Drastic_window)
        ...
        # button weight Soil
        self.labelWeightS = QLabel(Drastic_window)
        ...
        self.labelWeightT = QLabel(Drastic_window)
        ...
        self.labelWeightI = QLabel(Drastic_window)
        ...
        self.labelWeightC = QLabel(Drastic_window)
        ...
        self.inputLayerCombo = QComboBox(Drastic_window)
        self.inputLayerCombo.setObjectName("inputLayerCombo")  
        self.inputLayerCombo2 = QComboBox(Drastic_window)
        self.inputLayerCombo2.setObjectName("inputLayerCombo2")  
        self.inputLayerCombo3 = QComboBox(Drastic_window)
        self.inputLayerCombo3.setObjectName("inputLayerCombo3")  
        self.inputLayerCombo4 = QComboBox(Drastic_window)
        self.inputLayerCombo4.setObjectName("inputLayerCombo4")   
        self.inputLayerCombo5 = QComboBox(Drastic_window)
        self.inputLayerCombo5.setObjectName("inputLayerCombo5")  
        self.inputLayerCombo6 = QComboBox(Drastic_window)
        self.inputLayerCombo6.setObjectName("inputLayerCombo6")  
        self.inputLayerCombo7 = QComboBox(Drastic_window)
        ...
        self.buttonBox.rejected.connect(Drastic_window.close)
    
    def retranslateUi(self, Drastic_window):
        Drastic_window.setWindowTitle( 'DRASTIC')
        self.label.setText('D')
        self.label2.setText('R')
        self.label3.setText('A')
        self.label4.setText('S')
        self.label5.setText('T')
        self.label6.setText('I')
        self.label7.setText('C')
