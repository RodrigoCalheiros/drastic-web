...
from .Ui_Groundwater import Ui_Groundwater
...
class Groundwater(QDialog, Ui_Groundwater):
    ...
    def help(self):
        QMessageBox.about(self, "Groundwater occurrence", """<p><b>Groundwater occurrence</b></p> 
        <p><b>Definition:</b>The G factor lies in the identification of the degree of confinement of the aquifer. 
        ...
        <p><b>Output file:</b> Groundwater occurrence raster file</p>""")    
    
    # OUTPUT RASTER FILE
    def fillOutputFileEdit(self):
        lastUsedFilter = GdalTools_utils.FileFilter.lastUsedRasterFilter()
        outputFile = GdalTools_utils.FileDialog.getSaveFileName(self, self.tr( "Select the raster file to save the results to" ), '.sdat',
                                                                lastUsedFilter)
