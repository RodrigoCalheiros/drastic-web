...
class LU(QDialog, Ui_LU):
    ...
    def help(self):
        QMessageBox.about(self, "Land Use", """<p><b>Impact of Vadose Zone factor</b></p> 
    ...
    def convert(self):    
        ...
        for i in range(0,numberRows):
            #QMessageBox.about(self, "teste", str(i))
            for j in range(0,numberColumns):
                #QMessageBox.about(self, "teste", str(j))
        ...
        impact_zone = QFileInfo(QgsApplication.qgisUserDatabaseFilePath()).path() + "/impact_zone"
        ...
        # else:
        #     return False
        QMessageBox.information(self, self.tr( "Finished" ), self.tr( "Land Use completed." ) )                  
