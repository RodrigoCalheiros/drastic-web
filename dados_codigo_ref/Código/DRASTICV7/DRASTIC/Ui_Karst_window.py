...
class Ui_Karst_window(object):

    def setupUi(self, Karst_window):
        # create Karst window
        Karst_window.setWindowModality(QtCore.Qt.ApplicationModal)
        Karst_window.resize(450, 400)

        # input file
        # create gridLayout
        self.gridLayout1 = QGridLayout(Karst_window)
        self.gridLayout1.setObjectName("gridLayout1")
        # group box to input files
        self.groupBox = QGroupBox(Karst_window)
        ...
        self.label = QLabel(Karst_window)
        self.label.setObjectName("label")
        self.label2 = QLabel(Karst_window)
        self.label2.setObjectName("label2")
        self.label3 = QLabel(Karst_window)
        self.label3.setObjectName("label3")
        self.label4 = QLabel(Karst_window)
        self.label4.setObjectName("label4")
        self.label5 = QLabel(Karst_window)
        self.label5.setObjectName("label5")
        self.label6 = QLabel(Karst_window)
        self.label6.setObjectName("label6")
        self.label7 = QLabel(Karst_window)
        ...
        self.selectButton = QPushButton(Karst_window)
        self.selectButton.setObjectName("selectButton")
        self.selectButton2 = QPushButton(Karst_window)
        self.selectButton2.setObjectName("selectButton2")
        self.selectButton3 = QPushButton(Karst_window)
        self.selectButton3.setObjectName("selectButton3")
        self.selectButton4 = QPushButton(Karst_window)
        self.selectButton4.setObjectName("selectButton4")
        self.selectButton5 = QPushButton(Karst_window)
        self.selectButton5.setObjectName("selectButton5")
        self.selectButton6 = QPushButton(Karst_window)
        self.selectButton6.setObjectName("selectButton6")
        self.selectButton7 = QPushButton(Karst_window)
        self.selectButton7.setObjectName("selectButton7")

        # button weight Depth to Groundwater
        self.labelWeightD = QLabel(Karst_window)
        ...
        self.labelWeightR = QLabel(Karst_window)
        ...
        self.labelWeightA = QLabel(Karst_window)
        ...
        # button weight Soil
        self.labelWeightS = QLabel(Karst_window)
        ...
        self.labelWeightT = QLabel(Karst_window)
        ...
        self.labelWeightI = QLabel(Karst_window)
        ...
        self.labelWeightC = QLabel(Karst_window)
        ...
        self.label_checkKarst = QLabel(Karst_window)
        self.label_checkKarst.setObjectName("label_checkKarst")
        self.gridLayout3.addWidget(self.label_checkKarst, 1, 1, 1, 1)
        self.checkKarst = QCheckBox(Karst_window)
        self.checkKarst.setObjectName("checkKarst")
        self.gridLayout3.addWidget(self.checkKarst, 1, 0, 1, 1)



        # button Ok, Close and Help
        self.buttonBox = QDialogButtonBox(Karst_window)
        ...
        self.retranslateUi(Karst_window)
        self.buttonBox.rejected.connect(Karst_window.close)

    def retranslateUi(self, Karst_window):
        Karst_window.setWindowTitle('Karst')
        ...
        self.label_out.setText('Karst:')
        self.groupBox.setTitle("Input")
        self.groupBox2.setTitle("Output")
        self.label_checkKarst.setText('Load raster into canvas')
